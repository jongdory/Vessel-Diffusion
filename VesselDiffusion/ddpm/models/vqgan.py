...
from ddpm.models.normalization import SPADEResnetBlock, SPADEGenerator
from ddpm.modules.diffusionmodules.model import Encoder, Decoder # need to check
from ddpm.modules.vqvae.quantize import VectorQuantizer2 as VectorQuantizer
from ddpm.modules.vqvae.quantize import GumbelQuantize
from ddpm.modules.vqvae.quantize import EMAVectorQuantizer
...
class VQModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        source = self.modalities[random.randint(0, 3)]
        target = self.modalities[random.randint(0, 3)]
